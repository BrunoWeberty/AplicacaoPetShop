...
@section("content")      
          ...
          <div class="Container">
              <div class="page-header">
                <CENTER><h1>Cadastro de Tipo de Animais</h1></CENTER>        
               </div>
               <br/>
               <br/>
                <div class="col-sm-12"><!-- Container principal-->
                <form id="form" action="/tipo/salvar" method="post" class="valid rsform" enctype="multipart/form-data"><!-- Formulário-->
                  ...
                  <div class="form-group row col-sm-9"><!-- Div do input do nome-->
                    ...
                    <div class="col-sm-11">
                      <input type="text" class="form-control required" id="descricao" name="descricao" placeholder="Digite aqui o tipo de animal" value="{{ $tipos->descricao }}" data-nome="Descrição"/>
                    </div>
                  </div>
                  <br/>                 
